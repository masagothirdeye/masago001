...
# 現在のステップを表示するバー
steps_names = ["1. 写真のアップロード", "2. 台紙・枚数", "3. お届け先入力", "4. 最終確認", "5. 完了"]
...
if c_step == 1:
    ...
    if uploaded_file:
        ...
        # カレンダーの枠をイメージしたプレビュー
        st.write("▼ 配置イメージ（カレンダーの指定枠に収まります）")
...
# =========================================================
    ...
    data["template"] = template_option[0]
...
# =========================================================
    ...
    <div style="background-color: #ffffff; padding: 25px; border-radius: 8px; border: 1px solid #dcdcdc;">
        ...
        <p>🚨 <b>【ご注意】</b><br>
        商品の作成は、<b>ご入金が確認された後</b>に取り獲り掛かります。</p>
        <p>📅 <b>お届けの目安</b><br>
